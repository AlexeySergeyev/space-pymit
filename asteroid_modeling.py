...
def run_pipeline(param_file: str, lightcurve_file: str, output_areas_file: str = None, output_lc_file: str = None, 
                 plot_file: Union[str, bool] = None, obj_file: Union[str, bool] = None, plotly_file: Union[str, bool] = None, 
                 output_dir: str = None, asteroid_name: str = None) -> tuple[np.ndarray, list[list[int]]]:
    """
    ...
    try:
        ...
        # Cleanup temporary text file if we created one
        if tmp_lcs_file and Path(tmp_lcs_file).exists() and tmp_lcs_file != lightcurve_file:
            print(f"Cleaning up temporary file {tmp_lcs_file}...")
